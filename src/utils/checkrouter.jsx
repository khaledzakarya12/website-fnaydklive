...
export const isSportSelected = (currentPath) => currentPath === sportPath;
export const isEducatonalSelected = (currentPath) => currentPath === EducationalPath;
